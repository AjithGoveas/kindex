...
actual class IndexStorage actual constructor(dbPath: MPFile) {
    ...
    actual fun getFilesMetadata(): Map<String, Pair<Long, String>> {
        return transaction {
    ...
    actual fun searchSymbols(term: String): List<Symbol> {
        return transaction {
    ...
    actual fun getAllSymbols(): List<Symbol> {
        return transaction {
            SymbolsTable.selectAll()
                .map { row ->
                    Symbol(
    ...
    actual fun getIncomingDependencies(targetId: String): List<Edge> {
        return transaction {
    ...
    actual fun getOutgoingDependencies(sourceId: String): List<Edge> {
        return transaction {
            RelationshipsTable.selectAll()
    ...
    actual fun getAllEdges(): List<Edge> {
        return transaction {
            RelationshipsTable.selectAll()
                .map { row ->
                    Edge(
    ...
    actual fun getRepositoryStats(): RepositoryStats {
        return transaction {
